function [weight_update] = Weight_rules(weight_update, nr_learning_rounds, t_initial, t_final, nr_neurons_h, patterns_h, Ix, decay, S, D, saturation, noise)
...
for ii = 1:nr_learning_rounds
    ...
    p3 = find([sum((repmat(round(p1), 4, 1) == patterns_h(1:4,:))'), sum((repmat(1 - round(p1), 4, 1) == patterns_h(1:4,:))')] == nr_neurons_h);
