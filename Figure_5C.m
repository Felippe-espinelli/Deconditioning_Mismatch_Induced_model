...
Ratio_session_no_footshock_extinction_cue = zeros(100 , 1, Quant_ext_sessions, simulation_quantity);
...
Ratio_session_no_footshock_extinction_cue_nimodipine = zeros(100 , 1, Quant_ext_sessions, simulation_quantity);
weight_extinction_no_shock_nimodipine = zeros(nr_neurons_h, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
extinction_no_shock_session_activity_nimodipine = zeros(1, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
Activity_ret_all_neurons_no_footshock_nimodipine = zeros(1, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
...
for LLLL = 1:simulation_quantity
    ...
    if Extinction_choice_within_retrieval == 0
        for iiii = 1:Quant_ext_sessions
            ...
            % To adjust the ratio
            session_no_footshock_train_cue_Non_shock = session_no_footshock_train_cue_Non_shock + session_no_footshock_train_cue;
            Ratio_session_no_footshock_extinction_cue(:,:,iiii, LLLL) = (session_no_footshock_train_cue ./ session_no_footshock_train_cue_Non_shock);
    ...
    %  Reactivation Session
    for iii = 1:Quant_ext_sessions
        [weight_extinction_no_shock_nimodipine(:, :, iii, LLLL), extinction_no_shock_session_activity_nimodipine(:, :, iii, LLLL)] = Weight_rules_post_react_controlled_noise_V2(weight_update, nr_learning_rounds,...
            t_initial, t_final, nr_neurons_h, patterns_h, Ix, decay, S, D_nimo, saturation, Reexposure_noise, Reexposure_noise_state);
        weight_update = weight_extinction_no_shock_nimodipine(:, :, iii, LLLL);
        %     first_extinction_no_shock_session_activity = first_extinction_no_shock_session_activity(end, :);
    end
    
    if Extinction_choice_within_retrieval == 0
        for iiii = 1:Quant_ext_sessions
            weight_update = weight_extinction_no_shock_nimodipine(:,:,iiii, LLLL);
            Ix = cue_factor * retrieval_stimulus;
            retrieval_controlled_noise;
            session_no_footshock_train_cue = shock_neuron_activity;
            session_no_footshock_train_cue_Non_shock = Non_shock_neuron_activity;
            % To adjust the ratio
            session_no_footshock_train_cue_Non_shock = session_no_footshock_train_cue_Non_shock + session_no_footshock_train_cue;
            Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iiii, LLLL) = (session_no_footshock_train_cue ./ session_no_footshock_train_cue_Non_shock);
            Activity_ret_all_neurons_no_footshock_nimodipine(1,:,iiii, LLLL) = mean(mean_act_all_neurons);
...
Ratio_session_minor_footshock_train_cue_nimodipine = zeros(100 , 1, Quant_ext_sessions, simulation_quantity);
weight_extinction_minor_shock_nimodipine = zeros(nr_neurons_h, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
extinction_minor_shock_session_activity_nimodipine = zeros(1, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
Activity_ret_all_neurons_minor_footshock_nimodipine = zeros(1, nr_neurons_h, Quant_ext_sessions, simulation_quantity);
...
for LLLL = 1:simulation_quantity
    ...
    %  Reactivation Session
    for iii = 1:Quant_ext_sessions
        [weight_extinction_minor_shock_nimodipine(:, :, iii, LLLL), extinction_minor_shock_session_activity_nimodipine(:, :, iii, LLLL)] = Weight_rules_post_react_controlled_noise_V2(weight_update, nr_learning_rounds,...
            t_initial, t_final, nr_neurons_h, patterns_h, Ix, decay, S, D_nimo, saturation, Reexposure_noise, Reexposure_noise_state);
        weight_update = weight_extinction_minor_shock_nimodipine(:, :, iii, LLLL);
        %     first_extinction_minor_shock_session_activity = first_extinction_minor_shock_session_activity(end, :);
    end
    ...
    if Extinction_choice_within_retrieval == 0
        for iii = 1:Quant_ext_sessions
            ...
            % To adjust the ratio
            session_minor_footshock_train_cue_Non_shock = session_minor_footshock_train_cue_Non_shock + session_minor_footshock_train_cue;
            Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii, LLLL) = (session_minor_footshock_train_cue ./ session_minor_footshock_train_cue_Non_shock);
            Activity_ret_all_neurons_minor_footshock_nimodipine(1,:,iii, LLLL) = mean(mean_act_all_neurons);
...
Ratio_extinction_Within_session_no_footshock_train_cue_nimo = zeros(1, 1, Quant_ext_sessions, simulation_quantity);
...
for LLLL = 1:simulation_quantity
    for iii = 1:Quant_ext_sessions
        ...
        extinction_session_no_footshock_extinction_nimodipine = mean(extinction_no_shock_session_activity_nimodipine(:, Shock_neurons, iii, LLLL));
        extinction_session_no_footshock_extinction_Non_shock_nimodipine = mean(extinction_no_shock_session_activity_nimodipine(:, Non_shock_neurons, iii, LLLL));
        extinction_session_no_footshock_extinction_Non_shock_nimodipine = extinction_session_no_footshock_extinction_Non_shock_nimodipine + 1;
        Ratio_extinction_Within_session_no_footshock_train_cue_nimo(:,:,iii, LLLL) = (extinction_session_no_footshock_extinction_nimodipine ./ extinction_session_no_footshock_extinction_Non_shock_nimodipine);
        ...
        if iii == Quant_ext_sessions
            ...
            % To adjust the ratio
            session_no_footshock_train_cue_Non_shock = session_no_footshock_train_cue_Non_shock + session_no_footshock_train_cue;
            Ratio_session_no_footshock_train_cue_within_nimodipine(:,:,iii, LLLL) = (session_no_footshock_train_cue ./ session_no_footshock_train_cue_Non_shock);
            Activity_ret_all_neurons_no_footshock_within_nimodipine(1,:,iii, LLLL) = mean(mean_act_all_neurons);
...
for LLLL = 1:simulation_quantity
    ...
    % Retrieval - Weight update during retrieval
    % weight_update = weight_RENEWAL_session_no_footshock_group;
    weight_update = weight_extinction_no_shock_nimodipine(:,:, Quant_ext_sessions, LLLL);
    ...
    % To adjust the ratio
    Fifth_session_no_footshock_train_cue_Non_shock = Fifth_session_no_footshock_train_cue_Non_shock + Fifth_session_no_footshock_train_cue;
    Ratio_Fifth_session_no_footshock_train_cue_nimodipine(:,:, LLLL) = (Fifth_session_no_footshock_train_cue ./ Fifth_session_no_footshock_train_cue_Non_shock);
    Fifth_ret_all_neurons_no_footshock_nimodipine(:,:, LLLL) = mean(mean_act_all_neurons);
...
for LLLL = 1:simulation_quantity
    ...
    % Weight update
    [weight_sixth_session_no_footshock_group_nimodipine(:,:, LLLL), sixth_extinction_session_no_activity_temp] = Weight_rules_post_react_controlled_noise(weight_update, Learning_round_Retraining,...
        t_initial, t_final, nr_neurons_h, patterns_h, Ix, decay, S, D, saturation, Reexposure_noise, Reexposure_noise_state);
    sixth_extinction_session_no_activity_nimodipine(:,:,LLLL) = sixth_extinction_session_no_activity_temp(end, :);
    
    weight_update = weight_sixth_session_no_footshock_group_nimodipine(:,:, LLLL);
    Ix = cue_factor * retrieval_stimulus;
    Ix_retrieval_cue_training_train_cue = Ix;
    retrieval_controlled_noise;
    Sixth_session_no_footshock_train_cue = shock_neuron_activity;
    ...
    % To adjust the ratio
    Sixth_session_no_footshock_train_cue_Non_shock = Sixth_session_no_footshock_train_cue_Non_shock + Sixth_session_no_footshock_train_cue;
    Ratio_Sixth_session_no_footshock_train_cue_nimodipine(:,:, LLLL) = (Sixth_session_no_footshock_train_cue ./ Sixth_session_no_footshock_train_cue_Non_shock);
    Sixth_ret_all_neurons_no_footshock_nimodipine(:,:, LLLL) = mean(mean_act_all_neurons);
...
Ratio_extinction_Within_session_minor_footshock_train_cue_nimo = zeros(1, 1, Quant_ext_sessions, simulation_quantity);
...
for LLLL = 1:simulation_quantity
    for iii = 1:Quant_ext_sessions
        ...
        extinction_session_minor_footshock_extinction = mean(extinction_minor_shock_session_activity_nimodipine(:, Shock_neurons, iii, LLLL));
        extinction_session_minor_footshock_extinction_Non_shock = mean(extinction_minor_shock_session_activity_nimodipine(:, Non_shock_neurons, iii, LLLL));
        extinction_session_minor_footshock_extinction_Non_shock = extinction_session_minor_footshock_extinction_Non_shock + 1;
        Ratio_extinction_Within_session_minor_footshock_train_cue_nimo(:,:,iii, LLLL) = (extinction_session_minor_footshock_extinction ./ extinction_session_minor_footshock_extinction_Non_shock);
        ...
        if iii == Quant_ext_sessions
            ...
            % To adjust the ratio
            session_minor_footshock_train_cue_Non_shock = session_minor_footshock_train_cue_Non_shock + session_minor_footshock_train_cue;
            Ratio_session_minor_footshock_train_cue_within_nimodipine(:,:,iii, LLLL) = (session_minor_footshock_train_cue ./ session_minor_footshock_train_cue_Non_shock);
            Activity_ret_all_neurons_minor_footshock_within_nimodipine(:,:,iii, LLLL) = mean(mean_act_all_neurons);
        end
    end
end
...
for LLLL = 1:simulation_quantity
    ...
    % Retrieval
    % weight_update = weight_Renewal_session_minor_footshock_group;
    weight_update = weight_extinction_minor_shock_nimodipine(:,:, Quant_ext_sessions, LLLL);
    ...
    Fifth_session_minor_footshock_train_cue = Fifth_session_minor_footshock_train_cue ;
    Fifth_session_minor_footshock_train_cue_Non_shock = Fifth_session_minor_footshock_train_cue_Non_shock + Fifth_session_minor_footshock_train_cue;
    Ratio_Fifth_session_minor_footshock_train_cue_nimodipine(:,:, LLLL) = (Fifth_session_minor_footshock_train_cue ./ Fifth_session_minor_footshock_train_cue_Non_shock);
    Fifth_ret_all_neurons_minor_footshock_nimodipine(:,:, LLLL) = mean(mean_act_all_neurons);
...
for LLLL = 1:simulation_quantity
    ...
    % Weight update
    [weight_sixth_session_minor_footshock_group_nimodipine(:,:, LLLL), sixth_extinction_session_minor_activity_temp] = Weight_rules_post_react_controlled_noise(weight_update, Learning_round_Retraining, t_initial, t_final, nr_neurons_h, patterns_h, Ix, decay, S, D, saturation, Reexposure_noise, Reexposure_noise_state);
    sixth_extinction_session_minor_activity_nimodipine(:,:,LLLL) = sixth_extinction_session_minor_activity_temp(end, :);
    
    % Retrieval
    weight_update = weight_sixth_session_minor_footshock_group_nimodipine(:,:, LLLL);
    Ix = cue_factor * retrieval_stimulus;
    Ix_retrieval_cue_training_train_cue = Ix;
    retrieval_controlled_noise;
    Sixth_session_minor_footshock_train_cue = shock_neuron_activity;
    ...
    Sixth_session_minor_footshock_train_cue = Sixth_session_minor_footshock_train_cue ;
    Sixth_session_minor_footshock_train_cue_Non_shock = Sixth_session_minor_footshock_train_cue_Non_shock + Sixth_session_minor_footshock_train_cue;
    Ratio_Sixth_session_minor_footshock_train_cue_nimodipine(:,:, LLLL) = (Sixth_session_minor_footshock_train_cue ./ Sixth_session_minor_footshock_train_cue_Non_shock);
    Sixth_ret_all_neurons_minor_footshock_nimodipine(:,:, LLLL) = mean(mean_act_all_neurons);
end
...
if simulation_quantity > 1
    ...
    Ratio_session_no_footshock_extinction_cue = mean(Ratio_session_no_footshock_extinction_cue, 4);
    ...
    % WITH NIMODIPINE
    Activity_ret_all_neurons_no_footshock_nimodipine = mean(Activity_ret_all_neurons_no_footshock_nimodipine, 4);
    Fifth_ret_all_neurons_no_footshock_nimodipine = mean(Fifth_ret_all_neurons_no_footshock_nimodipine, 3);
    Sixth_ret_all_neurons_no_footshock_nimodipine = mean(Sixth_ret_all_neurons_no_footshock_nimodipine, 3);
    
    
    Activity_ret_all_neurons_minor_footshock_nimodipine = mean(Activity_ret_all_neurons_minor_footshock_nimodipine, 4);
    Fifth_ret_all_neurons_minor_footshock_nimodipine = mean(Fifth_ret_all_neurons_minor_footshock_nimodipine, 3);
    Sixth_ret_all_neurons_minor_footshock_nimodipine = mean(Sixth_ret_all_neurons_minor_footshock_nimodipine, 3);
    
    extinction_no_shock_session_activity_nimodipine = mean(extinction_no_shock_session_activity, 4);
    Activity_ret_all_neurons_no_footshock_within_nimodipine = mean(Activity_ret_all_neurons_no_footshock_within_nimodipine, 4);
    extinction_minor_shock_session_activity_nimodipine = mean(extinction_minor_shock_session_activity_nimodipine, 4);
    Activity_ret_all_neurons_minor_footshock_within_nimodipine = mean(Activity_ret_all_neurons_minor_footshock_within_nimodipine, 4);
    
    Ratio_session_no_footshock_extinction_cue_nimodipine = mean(Ratio_session_no_footshock_extinction_cue_nimodipine, 4);
    Ratio_session_minor_footshock_train_cue_nimodipine = mean(Ratio_session_minor_footshock_train_cue_nimodipine, 4);
    Ratio_Fifth_session_no_footshock_train_cue_nimodipine = mean(Ratio_Fifth_session_no_footshock_train_cue_nimodipine, 3);
    Ratio_Fifth_session_minor_footshock_train_cue_nimodipine = mean(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine, 3);
    Ratio_Sixth_session_no_footshock_train_cue_nimodipine = mean(Ratio_Sixth_session_no_footshock_train_cue_nimodipine, 3);
    Ratio_Sixth_session_minor_footshock_train_cue_nimodipine = mean(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine, 3);
...
if Extinction_choice_within_retrieval == 0
    ...
    for iii = 1:Quant_ext_sessions + 3
        if iii == 1
            h(figure_counter) = bar(0.75 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), 1, 'FaceColor', [0.6275 0 0]);
            h(figure_counter+1) = bar(2.25 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), 1, 'FaceColor', [1.0000 0.8784 0.8784]);
            h(figure_counter+2) = bar(3.75 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), 1, 'FaceColor', [0 0 0.5020]);
            h(figure_counter+3) = bar(5.25 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), 1, 'FaceColor', [0.7529 0.7529 1.0000]);
            
            scatter((0.75 + 7.25*(iii-1))*ones(length(Ratio_session_no_minor_footshock_training_retr),1), Ratio_session_no_minor_footshock_training_retr,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(0.75 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), std(Ratio_session_no_minor_footshock_training_retr)...
                /sqrt(length(Ratio_session_no_minor_footshock_training_retr)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            scatter((2.25 + 7.25*(iii-1))*ones(length(Ratio_session_no_minor_footshock_training_retr),1), Ratio_session_no_minor_footshock_training_retr,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(2.25 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), std(Ratio_session_no_minor_footshock_training_retr)...
                /sqrt(length(Ratio_session_no_minor_footshock_training_retr)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            scatter((3.75 + 7.25*(iii-1))*ones(length(Ratio_session_no_minor_footshock_training_retr),1), Ratio_session_no_minor_footshock_training_retr,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(3.75 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), std(Ratio_session_no_minor_footshock_training_retr)...
                /sqrt(length(Ratio_session_no_minor_footshock_training_retr)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            scatter((5.25 + 7.25*(iii-1))*ones(length(Ratio_session_no_minor_footshock_training_retr),1), Ratio_session_no_minor_footshock_training_retr,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(5.25 + 7.25*(iii-1), mean(Ratio_session_no_minor_footshock_training_retr), std(Ratio_session_no_minor_footshock_training_retr)...
                /sqrt(length(Ratio_session_no_minor_footshock_training_retr)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            figure_counter = figure_counter + 4;
            
            
        elseif iii <= Quant_ext_sessions + 1 && iii > 1
            % NO FOOTSHOCK
            h(figure_counter) = bar(0.75 + 7.25*(iii-1), mean(Ratio_session_no_footshock_extinction_cue(:,:,iii-1)), 1, 'FaceColor', [0.6275 0 0]);
            scatter((0.75 + 7.25*(iii-1))*ones(length(Ratio_session_no_footshock_extinction_cue(:,:,iii-1)),1), Ratio_session_no_footshock_extinction_cue(:,:,iii-1),...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(0.75 + 7.25*(iii-1), mean(Ratio_session_no_footshock_extinction_cue(:,:,iii-1)), std(Ratio_session_no_footshock_extinction_cue(:,:,iii-1))...
                /sqrt(length(Ratio_session_no_footshock_extinction_cue(:,:,iii-1))),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % NO FOOTSHOCK + NIMODIPINE
            h(figure_counter+1) = bar(2.25 + 7.25*(iii-1), mean(Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1)), 1, 'FaceColor', [1.0000 0.8784 0.8784]);
            scatter((2.25 + 7.25*(iii-1))*ones(length(Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1)),1), Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1),...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(2.25 + 7.25*(iii-1), mean(Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1)), std(Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1))...
                /sqrt(length(Ratio_session_no_footshock_extinction_cue_nimodipine(:,:,iii-1))),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % FOOTSHOCK
            h(figure_counter+2) = bar(3.75 + 7.25*(iii-1), mean(Ratio_session_minor_footshock_train_cue(:,:,iii-1)), 1, 'FaceColor', [0 0 0.5020]);
            scatter((3.75 + 7.25*(iii-1))*ones(length(Ratio_session_minor_footshock_train_cue(:,:,iii-1)),1), Ratio_session_minor_footshock_train_cue(:,:,iii-1),...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(3.75 + 7.25*(iii-1), mean(Ratio_session_minor_footshock_train_cue(:,:,iii-1)), std(Ratio_session_minor_footshock_train_cue(:,:,iii-1))...
                /sqrt(length(Ratio_session_minor_footshock_train_cue(:,:,iii-1))),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % FOOTSHOCK + NIMODIPINE
            h(figure_counter+3) = bar(5.25 + 7.25*(iii-1), mean(Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1)), 1, 'FaceColor', [0.7529 0.7529 1.0000]);
            scatter((5.25 + 7.25*(iii-1))*ones(length(Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1)),1), Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1),...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(5.25 + 7.25*(iii-1), mean(Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1)), std(Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1))...
                /sqrt(length(Ratio_session_minor_footshock_train_cue_nimodipine(:,:,iii-1))),'k.', 'markersize', 0.05, 'linewidth', 0.5);
        ...
        elseif iii == Quant_ext_sessions + 2
            % NO FOOTSHOCK
            h(figure_counter) = bar(0.75 + 7.25*(iii-1), mean(Ratio_Fifth_session_no_footshock_train_cue), 1, 'FaceColor', [0.6275 0 0]);
            scatter((0.75 + 7.25*(iii-1))*ones(length(Ratio_Fifth_session_no_footshock_train_cue),1), Ratio_Fifth_session_no_footshock_train_cue,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(0.75 + 7.25*(iii-1), mean(Ratio_Fifth_session_no_footshock_train_cue), std(Ratio_Fifth_session_no_footshock_train_cue)...
                /sqrt(length(Ratio_Fifth_session_no_footshock_train_cue)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % NO FOOTSHOCK + NIMODIPINE
            h(figure_counter+1) = bar(2.25 + 7.25*(iii-1), mean(Ratio_Fifth_session_no_footshock_train_cue_nimodipine), 1, 'FaceColor', [1.0000 0.8784 0.8784]);
            scatter((2.25 + 7.25*(iii-1))*ones(length(Ratio_Fifth_session_no_footshock_train_cue_nimodipine),1), Ratio_Fifth_session_no_footshock_train_cue_nimodipine,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(2.25 + 7.25*(iii-1), mean(Ratio_Fifth_session_no_footshock_train_cue_nimodipine), std(Ratio_Fifth_session_no_footshock_train_cue_nimodipine)...
                /sqrt(length(Ratio_Fifth_session_no_footshock_train_cue_nimodipine)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % FOOTSHOCK
            h(figure_counter+2) = bar(3.75 + 7.25*(iii-1), mean(Ratio_Fifth_session_minor_footshock_train_cue), 1, 'FaceColor', [0 0 0.5020]);
            scatter((3.75 + 7.25*(iii-1))*ones(length(Ratio_Fifth_session_minor_footshock_train_cue),1), Ratio_Fifth_session_minor_footshock_train_cue,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(3.75 + 7.25*(iii-1), mean(Ratio_Fifth_session_minor_footshock_train_cue), std(Ratio_Fifth_session_minor_footshock_train_cue)...
                /sqrt(length(Ratio_Fifth_session_minor_footshock_train_cue)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
            
            % FOOTSHOCK + NIMODIPINE
            h(figure_counter+3) = bar(5.25 + 7.25*(iii-1), mean(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine), 1, 'FaceColor', [0.7529 0.7529 1.0000]);
            scatter((5.25 + 7.25*(iii-1))*ones(length(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine),1), Ratio_Fifth_session_minor_footshock_train_cue_nimodipine,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
            errorbar(5.25 + 7.25*(iii-1), mean(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine), std(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine)...
                /sqrt(length(Ratio_Fifth_session_minor_footshock_train_cue_nimodipine)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
        ...
        elseif iii == Quant_ext_sessions + 3
            if Re_training_on_off == 1
                % NO FOOTSHOCK
                h(figure_counter) = bar(0.75 + 7.25*(iii-1), mean(Ratio_Sixth_session_no_footshock_train_cue), 1, 'FaceColor', [0.6275 0 0]);
                scatter((0.75 + 7.25*(iii-1))*ones(length(Ratio_Sixth_session_no_footshock_train_cue),1), Ratio_Sixth_session_no_footshock_train_cue,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
                errorbar(0.75 + 7.25*(iii-1), mean(Ratio_Sixth_session_no_footshock_train_cue), std(Ratio_Sixth_session_no_footshock_train_cue)...
                    /sqrt(length(Ratio_Sixth_session_no_footshock_train_cue)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
                
                % NO FOOTSHOCK + NIMODIPINE
                h(figure_counter+1) = bar(2.25 + 7.25*(iii-1), mean(Ratio_Sixth_session_no_footshock_train_cue_nimodipine), 1, 'FaceColor', [1.0000 0.8784 0.8784]);
                scatter((2.25 + 7.25*(iii-1))*ones(length(Ratio_Sixth_session_no_footshock_train_cue_nimodipine),1), Ratio_Sixth_session_no_footshock_train_cue_nimodipine,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
                errorbar(2.25 + 7.25*(iii-1), mean(Ratio_Sixth_session_no_footshock_train_cue_nimodipine), std(Ratio_Sixth_session_no_footshock_train_cue_nimodipine)...
                    /sqrt(length(Ratio_Sixth_session_no_footshock_train_cue_nimodipine)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
                
                % FOOTSHOCK
                h(figure_counter+2) = bar(3.75 + 7.25*(iii-1), mean(Ratio_Sixth_session_minor_footshock_train_cue), 1, 'FaceColor', [0 0 0.5020]);
                scatter((3.75 + 7.25*(iii-1))*ones(length(Ratio_Sixth_session_minor_footshock_train_cue),1), Ratio_Sixth_session_minor_footshock_train_cue,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
                errorbar(3.75 + 7.25*(iii-1), mean(Ratio_Sixth_session_minor_footshock_train_cue), std(Ratio_Sixth_session_minor_footshock_train_cue)...
                    /sqrt(length(Ratio_Sixth_session_minor_footshock_train_cue)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
                
                % FOOTSHOCK + NIMODIPINE
                h(figure_counter+3) = bar(5.25 + 7.25*(iii-1), mean(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine), 1, 'FaceColor', [0.7529 0.7529 1.0000]);
                scatter((5.25 + 7.25*(iii-1))*ones(length(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine),1), Ratio_Sixth_session_minor_footshock_train_cue_nimodipine,...
                'MarkerFaceColor', [0.5020 0.5020 0.5020], ...
                'LineWidth', 0.5, ...
                'MarkerEdgeColor', 'k');
                errorbar(5.25 + 7.25*(iii-1), mean(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine), std(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine)...
                    /sqrt(length(Ratio_Sixth_session_minor_footshock_train_cue_nimodipine)),'k.', 'markersize', 0.05, 'linewidth', 0.5);
    ...
    % Ticks
    if Re_training_on_off == 1
        session_ticks = 3 : 7.25 : ((Quant_ext_sessions+3)*7.25 )-2;
        xticks(session_ticks);
    else
        session_ticks = 3 : 7.25  : ((Quant_ext_sessions+2)*7.25 )-2;
        xticks(session_ticks);
    end
    ...
    legend('No Footshock', 'No Footshock + Nimodipine', 'Footshock', 'Footshock + Nimodipine', 'Location','NorthEastOutside');
    ylim([0 1])
...
if Extinction_choice_within_retrieval == 1
    ...
    for iii = 1:Quant_ext_sessions + 3
        if iii <= Quant_ext_sessions
            h(figure_counter) = bar(1 + 3*(iii-1), Ratio_extinction_Within_session_no_footshock_train_cue(:,:,iii), 1, 'r');
            
            h(figure_counter+1) = bar(2 + 3*(iii-1), Ratio_extinction_Within_session_minor_footshock_train_cue(:,:,iii), 1, 'b');
            
            figure_counter = figure_counter + 2;
        elseif iii == Quant_ext_sessions + 1
            h(figure_counter) = bar(1 + 3*(iii-1), mean(Ratio_session_no_footshock_train_cue_within), 1, 'r');
            
            h(figure_counter+1) = bar(2 + 3*(iii-1), mean(Ratio_session_minor_footshock_train_cue_within), 1, 'b');
            figure_counter = figure_counter + 2;
            
        elseif iii == Quant_ext_sessions + 2
            h(figure_counter) = bar(1 + 3*(iii-1), mean(Ratio_Fifth_session_no_footshock_train_cue), 1, 'r');
            
            h(figure_counter+1) = bar(2 + 3*(iii-1), mean(Ratio_Fifth_session_minor_footshock_train_cue), 1, 'b');
            figure_counter = figure_counter + 2;
        elseif iii == Quant_ext_sessions + 3
            h(figure_counter) = bar(1 + 3*(iii-1), mean(Ratio_Sixth_session_no_footshock_train_cue), 1, 'r');
            
            h(figure_counter+1) = bar(2 + 3*(iii-1), mean(Ratio_Sixth_session_minor_footshock_train_cue), 1, 'b');
            figure_counter = figure_counter + 2;
        end
    end
    ...
    for iii = 1:Quant_ext_sessions-1
        session_labels{iii} = ['E' num2str(iii)];
    end
    session_labels{Quant_ext_sessions} = 'Test';
    ...
    legend('No Footshock', 'No Footshock + Nimodipine', 'Footshock', 'Footshock + Nimodipine', 'Location','NorthEastOutside');
    ylim([0 1])
    ylabel('Percent freezing', 'fontsize', 24)
